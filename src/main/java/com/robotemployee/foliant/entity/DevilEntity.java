...
import com.robotemployee.foliant.entity.ai.FlyingWanderGoal;
import com.robotemployee.foliant.entity.ai.FollowMobTypeGoal;
    ...
    public static class ProtectGoal extends FollowMobTypeGoal {
        ...
        protected void applyBuffs() {
            ...
            if (!(getTarget() instanceof FoliantRaidMob foliant) || foliant.canDevilGrantKnockbackResistance()) {
                //FIXME
                // do not add a dependency on alex's mobs just for this. that's silly as fuck
                // implement your own knockback resistance effect. sounds easy asf to be honest. do it.
