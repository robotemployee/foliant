...
import com.robotemployee.foliant.entity.ai.*;
import com.robotemployee.foliant.registry.ModSounds;
import com.robotemployee.reu.util.LevelUtils;
import com.robotemployee.reu.util.sound.EntitySoundInstanceThatTicks;
...
public class GregEntity extends FoliantRaidMob implements GeoEntity {
    ...
    public static final SerializableDataTicket<String> VISUAL_STATE = GeckoLibUtil.addDataTicket(SerializableDataTicket.ofString(new ResourceLocation(Foliant.MODID, "visual_state")));
    ...
    protected void registerGoals() {
        ...
        targetSelector.addGoal(targetIndex++, new HurtByTargetGoal(this, FoliantRaidMob.class).setAlertOthers(IFoliantNonAttacking.class));
