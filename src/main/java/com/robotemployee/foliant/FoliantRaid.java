...
import com.robotemployee.foliant.registry.ModEntities;
...
public class FoliantRaid {
    ...
    protected void startForceloadingChunks() {
        ...
        for (int x = -chunkRadius; x <= chunkRadius; x++) {
            for (int z = -chunkRadius; z <= chunkRadius; z++) {
                ...
                ForgeChunkManager.forceChunk(level, Foliant.MODID, epicenter, pos.x, pos.z, true, true);
            }
        }
    }
    ...
    protected void stopForceloadingChunks() {
        loadedChunks.forEach(pos -> {
            ...
            ForgeChunkManager.forceChunk(level, Foliant.MODID, epicenter, pos.x, pos.z, false, true);
        });
        loadedChunks.clear();
    }
