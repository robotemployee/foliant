...
import com.robotemployee.foliant.model.DevilEntityModel;
...
public class DevilRenderer extends FoliantRenderer<DevilEntity> {
    ...
    public static final ResourceLocation WINGS_TEXTURE = new ResourceLocation(Foliant.MODID, "textures/entity/devil/devilwings.png");

    public static final ResourceLocation BEAM_TEXTURE = new ResourceLocation(Foliant.MODID, "textures/entity/devil/devilbeam.png");
