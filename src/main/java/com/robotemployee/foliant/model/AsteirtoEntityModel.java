...
import com.robotemployee.foliant.entity.AsteirtoEntity;
...
public class AsteirtoEntityModel extends GeoModel<AsteirtoEntity> {
    ...
    public ResourceLocation getModelResource(AsteirtoEntity animatable) {
        return new ResourceLocation(Foliant.MODID, "geo/asteirto.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(AsteirtoEntity animatable) {
        return new ResourceLocation(Foliant.MODID, "textures/entity/asteirto/rosepike.png");
    }

    @Override
    public ResourceLocation getAnimationResource(AsteirtoEntity animatable) {
        return new ResourceLocation(Foliant.MODID, "animations/asteirto.animation.json");
    }
